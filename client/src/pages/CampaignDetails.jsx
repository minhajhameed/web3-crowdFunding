    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          <h4 className="font-epilogue font-semibold text-[18px] dark:text-white text-black uppercase">Fund</h4>   

          <div className="mt-[20px] flex flex-col p-4 bg-[#ffffff] dark:bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              <input 
                ...
                placeholder="ETH 0.1"
                step="0.01"
                className="w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-transparent font-epilogue dark:text-white text-black text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px]"
                value={amount}
