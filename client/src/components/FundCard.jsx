...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] dark:bg-[#1c1c24] bg-[#ffffff] cursor-pointer" onClick={handleClick}>
      <img src={image} alt="fund" className="w-full p-1 h-[170px] object-cover rounded-[15px]"/>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          <h3 className="font-epilogue font-semibold text-[18px] dark:text-white text-black text-left leading-[26px] truncate">{title}</h3>
        ...
        <div className="flex items-center mt-[16px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#ededed] dark:bg-[#13131a]">
